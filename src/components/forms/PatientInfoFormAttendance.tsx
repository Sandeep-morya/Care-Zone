...
interface Props {
	patientInfo: PatientInfoAttendance;
	setPatientInfo: Dispatch<SetStateAction<PatientInfoAttendance>>;
}

const PatientInfoFormAttendance = ({ patientInfo, setPatientInfo }: Props) => {
	...
	return (
		<div>
			...
			<div className="flex flex-col lg:grid lg:grid-cols-3 gap-x-4 gap-4">
				...
				<div className="col-span-3 flex flex-col gap-2">
					<label className="text-sm " htmlFor="headings">
						Headings
					</label>
					<input
						type="text"
...
export default PatientInfoFormAttendance;
